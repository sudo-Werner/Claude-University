...
_IMAGES_BLOCK = (
    ...
    "photo is first-class whenever the learner must recognize a real thing by appearance. Every figure "
...
def lesson_prompt(*, brief, profile, lesson_id, lesson_title, module_title, position, total,
    ...
    return (
        ...
        "- The same applies to solutionAns: if the answer has multiple parts or steps, break them "
        "out with a <ul> and wrap key terms in <strong> instead of chaining everything into one "
        "dense sentence with semicolons and arrows. A short, single-fact answer can stay one plain "
        "sentence.\n"
